  ...
  <!-- ------------------------------------------------------------
                       /!\ IMPORTANT /!\
    In order to linking between each pages for ajax navigation menu, 
    this ".link-page" class must be included inside of
    your link (a) element. -Andi Dwi Saputro-2019-28-Feb
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      <a class="nav-link link-page" href="#" name="entrySPPD" aria-expanded="true">
    ...
    <li class="nav-item">
      <a class="nav-link link-page" href="#" name="historySPPD" aria-expanded="true">
        <i class="fas fa-fw fa-clock"></i>
        <span>History SPPD</span>
      </a>
    </li>

    <li class="nav-item">
      <a class="nav-link link-page" href="#" name="inboxSPPD" aria-expanded="true">
        <i class="fas fa-fw fa-envelope"></i>
        <span>inbox SPPD</span>
      </a>
    </li>
